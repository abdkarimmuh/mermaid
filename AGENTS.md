...
A Next.js app for writing Mermaid diagrams and previewing them live. Routes: `/` (landing), `/editor` (live editor, `components/mermaid/mermaid-editor.tsx`), `/docs` (syntax cheatsheet).
